...
<body>
    ...
    function fetchDocuments() {
        $.ajax({
            url: 'fetch_supply_documents.php', // Adjust the URL to match your PHP script's filename
            type: 'GET',
            success: function(response) {
                ...
                documents.forEach(function(document) {
                    ...
                    var downloadLink = $('<a>').attr('href', 'supply_download.php?id=' + document.id).text('Download');
    ...
    $('#deleteSelectedBtn').click(function() {
        ...
        $.ajax({
            url: 'supply_delete_documents.php',
            type: 'POST',
