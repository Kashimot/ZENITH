...
$targetDir = "uploads/supply_department/"; // Directory to store uploaded files under facilities_department
...
if (in_array($fileType, $allowedTypes)) {
    ...
    if (move_uploaded_file($tempFilePath, $targetFilePath)) {
        ...
        $sql = "INSERT INTO supply_department_documents (file_name, original_name, file_path, upload_date) 
