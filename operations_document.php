...
<head>
    ...
    <title>Operations Documents</title>
...
<body>
    ...
    <aside class="sidebar">
        <ul>
            <li><a href="operations_department.php">Home</a></li>
            <li><a href="operations_send_to_admin.php">Send to Admin</a></li>
            <li><a href="ongoing_operations.php" class="nav-btn">Ongoing Operations</a></li>
        </ul>
    </aside>
    ...
    function fetchDocuments() {
        $.ajax({
            url: 'fetch_operations_uploaded_documents.php', // Adjust the URL to match your PHP script's filename
            type: 'GET',
            success: function(response) {
                ...
                documents.forEach(function(document) {
                    ...
                    var downloadLink = $('<a>').attr('href', 'operations_download.php?id=' + document.id).text('Download');
    ...
    $('#deleteSelectedBtn').click(function() {
        ...
        $.ajax({
            url: 'operations_delete_documents.php',
            type: 'POST',
